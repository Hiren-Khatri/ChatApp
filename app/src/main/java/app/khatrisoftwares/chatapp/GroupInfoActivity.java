...
public class GroupInfoActivity extends AppCompatActivity {
    ...
    private TextView descriptionTv,createdByTv,editGroupTv,
            addParticipantTv,leaveGroupTv,participantsTv;
        ...
        ref.child(groupId).child("Participants").child(firebaseAuth.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Snackbar.make(findViewById(android.R.id.content),"Left from Group Successfully...",Snackbar.LENGTH_SHORT).setBackgroundTint(getColor(R.color.colorPrimaryDark)).show();
    ...
    private void deletedGroup() {
        ...
        ref.child(groupId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Snackbar.make(findViewById(android.R.id.content),"Group deleted successfully...",Snackbar.LENGTH_SHORT).setBackgroundTint(getColor(R.color.colorPrimaryDark)).show();
                        startActivity(new Intent(GroupInfoActivity.this,DashboardActivity.class));
                        finish();
                    }
                })
    ...
    private void loadCreatorInfo(final String dateTime, String createdBy) {
        ...
        userData.orderByChild("uid").equalTo(createdBy)
                .addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()){
    ...
    private void loadMyGroupRole() {
        ...
        ref1.child(groupId).child("Participants").orderByChild("uid").equalTo(firebaseAuth.getUid())
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                      for (DataSnapshot ds : dataSnapshot.getChildren()){
